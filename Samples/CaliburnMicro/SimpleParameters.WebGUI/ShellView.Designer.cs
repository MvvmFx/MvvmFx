namespace SimpleParameters.UI
{
    partial class ShellView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.showButtonTest = new Gizmox.WebGUI.Forms.Button();
            this.showButtonParameterTest = new Gizmox.WebGUI.Forms.Button();
            this.showMenuStripTest = new Gizmox.WebGUI.Forms.Button();
            this.showToolStripTest = new Gizmox.WebGUI.Forms.Button();
            this.ActiveItem = new MvvmFx.CaliburnMicro.ContentContainer();
            this.menuStrip1 = new Gizmox.WebGUI.Forms.MenuStrip();
            this._buttonNr = new Gizmox.WebGUI.Forms.Label();
            this._model_buttonDescription = new Gizmox.WebGUI.Forms.Label();
        ...
        private Gizmox.WebGUI.Forms.Button showButtonParameterTest;
        private Gizmox.WebGUI.Forms.Button showButtonTest;
        private Gizmox.WebGUI.Forms.Button showMenuStripTest;
        private Gizmox.WebGUI.Forms.Button showToolStripTest;
        private MvvmFx.CaliburnMicro.ContentContainer ActiveItem;
        private Gizmox.WebGUI.Forms.MenuStrip menuStrip1;
        private Gizmox.WebGUI.Forms.Label _buttonNr;
        private Gizmox.WebGUI.Forms.Label _model_buttonDescription;
