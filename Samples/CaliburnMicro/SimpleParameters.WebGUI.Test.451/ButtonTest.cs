...
namespace SimpleParameters.WebGUI.Test
{
    ...
    public class ButtonTest
    {
        ...
        [Test]
        public void GotoButtonTestForm()
        {
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if (IsElementPresent(By.XPath("//div[@id='VWG_5']/div/div/div/table/tbody/tr/td/span")))
                        break;
                }
                catch (Exception)
                {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if (IsElementPresent(By.XPath("//div[@id='VWG_39']/div/div/div/table/tbody/tr/td/span")))
                        break;
                }
                catch (Exception)
                {
        ...
        public void TheButtonTest()
        {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if ("Type: Gizmox.WebGUI.Forms.BindingContext" == driver.FindElement(By.Id("TRG_27")).Text)
                        break;
                }
                catch (Exception)
                {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if ("DataContext is null" == driver.FindElement(By.Id("TRG_27")).Text)
                        break;
                }
                catch (Exception)
                {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if ("Type: Gizmox.WebGUI.Forms.MouseEventArgs\r\nX: 50\r\nY: 11" ==
                        driver.FindElement(By.Id("TRG_27")).Text)
                        break;
                }
                catch (Exception)
                {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if ("Type: Gizmox.WebGUI.Forms.Button\r\nName: button4" == driver.FindElement(By.Id("TRG_27")).Text)
                        break;
                }
                catch (Exception)
                {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if ("cb27 cb30 cu1" == driver.FindElement(By.Id("VWG_32")).GetAttribute("class"))
                        break;
                }
                catch (Exception)
                {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if ("12" == driver.FindElement(By.Id("TRG_27")).Text)
                        break;
                }
                catch (Exception)
                {
            ...
            for (int second = 0;; second++)
            {
                ...
                try
                {
                    if ("1" == driver.FindElement(By.Id("TRG_27")).Text)
                        break;
                }
                catch (Exception)
                {
