...
namespace BoundTreeView.Views
{
    public partial class FamilyMemberEditView : UserControl, IHaveDataContext
    {
        ...
        private void Bind()
        {
            ...
            modelDateOfBirth.DataBindings.Add(new Gizmox.WebGUI.Forms.Binding("Text", _viewModel.Model, "DateOfBirth", false, DataSourceUpdateMode.OnValidation));
