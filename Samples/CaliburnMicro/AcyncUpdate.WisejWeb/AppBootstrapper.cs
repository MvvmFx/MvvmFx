...
{
    internal class AppBootstrapper : Bootstrapper<IAsyncUpdateViewModel>
    {
        ...
        /*internal AppBootstrapper()
            : base()
        {
            ApplicationContext.SetStartupForm(new AsyncUpdateView());
        }
        ...
        protected override void Configure()
        {
            ...
            _container
                .Singleton<IAsyncUpdateViewModel, AsyncUpdateViewModel>()
