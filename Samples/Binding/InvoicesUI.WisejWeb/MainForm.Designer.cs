namespace InvoicesUI.WisejWeb
{
    partial class MainForm
    {
        ...
        {
            this.stringBindingsINPC = new Wisej.Web.Button();
            this.lambdaBindingsINPC = new Wisej.Web.Button();
            this.stringBindingsValidation = new Wisej.Web.Button();
            this.lambdaBindingsValidation = new Wisej.Web.Button();
            this.SuspendLayout();
            // 
            // stringBindingsINPC
            // 
        ...
        private Wisej.Web.Button stringBindingsINPC;
        private Wisej.Web.Button lambdaBindingsINPC;
        private Wisej.Web.Button stringBindingsValidation;
        private Wisej.Web.Button lambdaBindingsValidation;
    }
}