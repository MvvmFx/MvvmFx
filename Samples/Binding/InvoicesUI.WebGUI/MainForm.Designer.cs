namespace InvoicesUI
{
    partial class MainForm
    {
        ...
        {
            this.stringBindingsINPC = new Gizmox.WebGUI.Forms.Button();
            this.lambdaBindingsINPC = new Gizmox.WebGUI.Forms.Button();
            this.stringBindingsValidation = new Gizmox.WebGUI.Forms.Button();
            this.lambdaBindingsValidation = new Gizmox.WebGUI.Forms.Button();
            this.SuspendLayout();
            // 
            // stringBindingsINPC
            // 
        ...
        private Gizmox.WebGUI.Forms.Button stringBindingsINPC;
        private Gizmox.WebGUI.Forms.Button lambdaBindingsINPC;
        private Gizmox.WebGUI.Forms.Button stringBindingsValidation;
        private Gizmox.WebGUI.Forms.Button lambdaBindingsValidation;
    }
}