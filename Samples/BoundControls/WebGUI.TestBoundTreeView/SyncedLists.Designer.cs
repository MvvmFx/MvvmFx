namespace WebGUI.TestBoundTreeView
{
    partial class SyncedLists
    {
        ...
        private Gizmox.WebGUI.Forms.Button dgvButtonModel;
        private Gizmox.WebGUI.Forms.TextBox dgvTextboxModel;
        private Gizmox.WebGUI.Forms.TextBox dgvTextboxView;
        private Gizmox.WebGUI.Forms.Button dgvButtonView;
        private Gizmox.WebGUI.Forms.ListBox listBox1;
        private Gizmox.WebGUI.Forms.Button lbButtonView;
        private Gizmox.WebGUI.Forms.TextBox lbTextboxView;
        private Gizmox.WebGUI.Forms.TextBox lbTextboxModel;
        private Gizmox.WebGUI.Forms.Button lbButtonModel;
        private Gizmox.WebGUI.Forms.BindingSource docTypeListBindingSource;
        private Gizmox.WebGUI.Forms.Button lvButtonView;
        private Gizmox.WebGUI.Forms.TextBox lvTextboxView;
        private Gizmox.WebGUI.Forms.TextBox lvTextboxModel;
        private Gizmox.WebGUI.Forms.Button lvButtonModel;
        private MvvmFx.WebGUI.Forms.BoundListView boundListView1;
        private Gizmox.WebGUI.Forms.Button tvButtonView;
        private Gizmox.WebGUI.Forms.TextBox tvTextboxView;
        private Gizmox.WebGUI.Forms.TextBox tvTextboxModel;
        private Gizmox.WebGUI.Forms.Button tvButtonModel;
        private MvvmFx.WebGUI.Forms.BoundTreeView boundTreeView1;
        private Gizmox.WebGUI.Forms.Label label1;
        private Gizmox.WebGUI.Forms.Label docTypeName;
        private Gizmox.WebGUI.Forms.Button queryObjectButton;
        ...
        private Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn docTypeIDDataGridViewTextBoxColumn;
        private Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn docTypeNameDataGridViewTextBoxColumn;
        private Gizmox.WebGUI.Forms.ColumnHeader columnDocTypeID;
        private Gizmox.WebGUI.Forms.ColumnHeader columnDocTypeName;
