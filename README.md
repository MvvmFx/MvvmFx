The MVVM FX project targets Windows Forms, Visual WebGUI and Wisej.
...
In order to do proper MVVM, one must use controls that support data binding. Some of the standard Windows Forms controls (or Visual WebGUI controls and Wisej for that matter) don't comply with this requirement, namely TreeView. The bound controls library fills this gap.
