...
namespace MvvmFx.Bindings.WindowsBase.Data
{
    /// <summary>
    ...
    public abstract class PropertyExpressionPart
    {
        ...
        private static readonly ICollection<IPropertyObservationStrategy> PropertyObservationStrategies =
            new List<IPropertyObservationStrategy>(new IPropertyObservationStrategy[]
            {
                ...
                new TriggerEventObservationStrategy(),
        ...
        private void PropertyObservation_ValueChanged(object sender, EventArgs e)
        {
        ...
        {
            IPropertyObservation AttemptAttach(object obj, string name);
        }
        ...
        private interface IPropertyObservation
        {
            ...
            void Detach(object obj, string name);
        }
        ...
        /// <summary>
        /// A property observation strategy that looks for TriggerEvent on the target object.
        /// </summary>
        private sealed class TriggerEventObservationStrategy : IPropertyObservationStrategy
        {
            public IPropertyObservation AttemptAttach(object obj, string eventName)
            {
                var changedEvent = TypeDescriptor.GetEvents(obj).Find(eventName, false);

                if (changedEvent != null)
                {
                    return new TriggerEventPropertyObservation(changedEvent, obj);
                }

                return null;
            }

            private sealed class TriggerEventPropertyObservation : IPropertyObservation
            {
                ...
                public void Detach(object obj, string eventName)
                {
                    var changedEvent = TypeDescriptor.GetEvents(obj).Find(eventName, false);
                    Debug.Assert(changedEvent != null);
