...
{
	public class When_binding_to_multiple_sources_with_path_using_the_fluent_interface
	{
		...
		{
			var ex = Assert.Throws<ArgumentNullException>(() => _bindingManager.MultiBind(_targetObject, (string)null));
		...
		public void nothing_happens_without_activation()
		{
			...
			_bindingManager.MultiBind(_targetObject, "Name")
				.WithConverter(converter.Object, "Some Parameter")
				.TwoWay()
					.To(_sourceObject, "Line1")
					.AndTo(_sourceObject, "Line2")
					.AndTo(_sourceObject, "Line3");
