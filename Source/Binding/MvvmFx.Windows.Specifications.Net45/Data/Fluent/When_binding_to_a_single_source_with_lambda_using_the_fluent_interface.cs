...
{
	public class When_binding_to_a_single_source_with_lambda_using_the_fluent_interface
	{
		private readonly BindingManager _bindingManager;
		private readonly Person _targetObject;
		private readonly Address _sourceObject;

		public When_binding_to_a_single_source_with_lambda_using_the_fluent_interface()
		{
		...
		{
			var ex = Assert.Throws<ArgumentNullException>(() => _bindingManager.Bind(_targetObject, null));
		...
		public void nothing_happens_without_activation()
		{
			...
			_bindingManager.Bind(_targetObject, o => o.Name)
				.To(_sourceObject, o => o.Line1)
