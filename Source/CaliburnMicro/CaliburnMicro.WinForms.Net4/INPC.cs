namespace MvvmFx.CaliburnMicro
{
    ...
    public static class Execute
    {
        ...
        public static bool InDesignMode
        {
            get
            {
                if (inDesignMode == null)
                {
                    ...
                    if(!inDesignMode.GetValueOrDefault(false) &&
        ...
        public static void InitializeWithDispatcher()
        {
            ...
            {
                var dlg = new Form();
                dlg.Name = "Default Marshalling Context";
    ...
    {
        /// <summary>
        ///   Initializes a new instance of the <see cref = "MvvmFx.CaliburnMicro.BindableCollection{T}" /> class.
        /// </summary>
